...
class Individuo():
    def __init__(self, espacos, valores, limite_espacos, geracao=0):
        ...
        #recebe o somatório dos valores que entraram no carregamento
        self.nota_avaliacao = 0
        #recebe o somátorio do espaço utilizado
        self.espaco_usado = 0
    ...
    def avaliacao(self):
        ...
        for i in range(len(self.cromossomo)):
            #se o cromossomo na posição i for igual a 1
            if self.cromossomo[i] == '1':
                #somaremos os valores e os espaços
                nota += self.valores[i]
    ...
    def crossover(self, outro_individuo):
        ...
        #do cromossomo, neste caso 14
        corte = round(random() * len(self.cromossomo))
        #pega o indidivudo do cromossomo da posição 0 até da de corte, 
        #somando com o cromossomo do corte até o restante
...
class AlgoritmoGenetico():
    ...
    def iniciliazaPopulacao(self, espacos, valores, limite_espacos):
...
if __name__ == '__main__':
    ...
    lista_produtos.append(Produto("Microondas LG", 0.0554, 429.90))
    lista_produtos.append(Produto("Microondas Brastemp", 0.0319, 299.90))
    ...
    ag.iniciliazaPopulacao(espacos, valores, limite)
    for individuo in ag.populacao:
        individuo.avaliacao()
    ag.ordena_populacao()
    ag.melhor_individuo(ag.populacao[0])
    soma = ag.soma_avaliacao()
    nova_populacao = []
